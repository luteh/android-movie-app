...
import com.luteh.main.BuildConfig;
...
public final class Configuration {
    ...
    private final SharedPreferences mPrefsAuthState;
    ...
    public Configuration(Context context) {
        ...
        mPrefsAuthState = context.getSharedPreferences(AuthStateManager.STORE_NAME, Context.MODE_PRIVATE);
    ...
    public void readConfiguration() throws InvalidConfigurationException {
        Log.d(TAG, "190 readConfiguration: buildType-> "+ BuildConfig.BUILD_TYPE);
        BufferedSource configSource;

        if(BuildConfig.BUILD_TYPE.equalsIgnoreCase("release")){
            configSource = Okio.buffer(Okio.source(mResources.openRawResource(R.raw.auth_config_release)));
        }else{
            configSource =
        ...
        // TODO: 30/03/2021 Adjust the codes based on the server
//        if (isNotFirstTimeAuthorized()) {
//            mClientId = "register-user";
//        } else {
...
//        }
    ...
    private boolean isNotFirstTimeAuthorized() {
        return mPrefsAuthState.getBoolean(AuthStateManager.KEY_IS_NOT_FIRST_TIME_AUTHORIZED, false);
    }
